...
In the lab, we have micro-HDMI to HDMI converters. You will use this to plug your
reTerminal into the lab monitor.

Plug your reTerminal into the lab monitor, and into the wall -- you should see the
reTerminal log in. Follow the steps below to install the necessary drivers to fix the
reTerminal screen issues.
