...
First, create an account on [Tailscale](https://login.tailscale.com/start). You have the following choices for authentication:
...
[Follow these instructions](https://tailscale.com/kb/1295/install-windows-wsl2)
...
- Windows: 
    ...
    - ALSO install on your main Windows machine by [following these instructions](https://tailscale.com/kb/1022/install-windows)
