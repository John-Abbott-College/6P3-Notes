...
The Azure documentation has instructions for both in the document
[Create and manage Azure IoT Hubs](https://learn.microsoft.com/en-us/azure/iot-hub/create-hub?tabs=portal).

Make sure you make the following selections:
...
Keep defaults for all subsequent menus (Networking, Management, Add-ons, Tags).
