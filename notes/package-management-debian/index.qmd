...
subtitle:
  Installing and configuring Linux packages on Raspberry Pi Debian using the
  `apt` package manager.
...
::: {.callout-important} Important: see
[the March 14 announcement about upgrading your Pi](/announcements/2024-03-14-pi-update.qmd)
if at any point a system update causes hardware issues (e.g. your screen stops
working) :::
