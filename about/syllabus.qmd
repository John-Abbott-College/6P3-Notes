...
- **Course webpage:** This website for all content, [Moodle]({{< site.moodle >}}) for assignment/project/quiz submissions.
...
- [Moodle]({{< site.moodle >}}) - For receiving & submitting exercises/assignments/project
  and getting marks
