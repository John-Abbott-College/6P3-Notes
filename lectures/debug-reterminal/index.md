...
1. System update using `apt`: during the semester, some changes that break
   ...
   [Display driver fix scripts.](/lectures/reterminal-setup/index.md#display-driver-fix)
...
the end. You should open [Reterminal Setup instructons](/lectures/reterminal-setup/index.md)
