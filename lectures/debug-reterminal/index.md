...
1. System update using `apt`: during the semester, some changes that break
   ...
   [Display driver fix scripts.](/labs/reterminal-setup/index.md#display-driver-fix)
...
the end. You should open [Reterminal Setup instructons](/labs/reterminal-setup/index.md)
