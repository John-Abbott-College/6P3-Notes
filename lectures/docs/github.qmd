...
subtitle:
  For now, just a note about authenticating in the terminal. More to come.
date: 2024-04-08
categories: []
draft: true
---
...
I will update this lecture with tips and tricks for using GitHub effectively.
For now:

- Using github from the reTerminal

## Using GitHub from reTerminal

When cloning a private repository to your reTerminal you might get a
...
Authenticating over SSH involves the following steps (with links to official
docs):
