...
subtitle: "How communication protocols can be optimized for device-cloud communication, i.e. why not everything should use HTTP"
date: 2024-04-15
...
Figures from: [Broker and client relationship](https://github.com/microsoft/IoT-For-Beginners/tree/main/1-getting-started/lessons/4-connect-internet), IoT for Beginners, Microsoft.
...
Message Queueing Telemetry Transport, i.e. [MQTT](http://mqtt.org), is a lightweight pub/sub protocol. It was originally designed to monitor oil pipelines where connectivity could not be guaranteed.
