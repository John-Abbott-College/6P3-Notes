...
subtitle:
  Understanding the General Purpose Input and Output (GPIO) pins our reSeed
  terminal chassis makes available to us. Voltage, digital vs. analog, python
  libraries for GPIO.
date: 2024-02-26
...
::: {.callout-important} While connecting up simple components to the GPIO pins
