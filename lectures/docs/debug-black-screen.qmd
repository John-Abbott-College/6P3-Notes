...
the end. You should open Lab 1 instructions for reference while you are working
for reference ([Lab 1 Section 1 link][lab1-sec1], [Lab 2 Section 2
link][lab1-sec2]). The following steps will be necessary:
