...
![Examples of industrial and consumer iot applications](../assets/1-iot-intro-industrial-vs-consumer.png)
...
![](../assets/1-iot-intro-cloud-service-providers.png)
...
2. Search for **_Cost Management_**
   ![](../assets/intro-azure-cost-management.png ":class=inline-img")

3. Select **_Payment methods_**

4. Check your **_Azure credits_** panel.
