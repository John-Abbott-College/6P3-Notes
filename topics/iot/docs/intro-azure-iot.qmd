...
This lecture serves as background information you should know to complete Lab 6 and Assignment 2 -- I will link to this lecture from those assignments frequently.
...
Figure from: [SaaS vs PaaS vs IaaS](https://docs.microsoft.com/en-us/learn/modules/introduction-iot-solution-), What is PaaS?, Microsoft.

So far in this course, we have developed applications that are almost entirely local to our reTerminal (production) and workstation (development) environments. We did not worry ourselves terribly about data storage, application logic, authentication, etc. We could implement these things using Flask/Dash in Python, but we can also automate many of them using a PaaS framework.
...
Figure from: [Subsystems of IoT architecture](https://docs.microsoft.com/en-us/learn/modules/introduction-iot-solution-architecture/2-subsystems-iot-architecture), Examine systems of an IoT architecture, Microsoft.
