...
- [Device twin's reported properties](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-device-twins) for reporting device state information such as configuration or last known state. [Course notes on Device twins](/topics/iot/docs/device-twins.qmd)
...
- [Twin's desired properties](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-device-twins) for long-running commands intended to put the device into a certain desired state. For example, set the telemetry send interval to 30 minutes. [Course notes on Device twins](/topics/iot/docs/device-twins.qmd)
...
You can also review **Lab 6** ([Section 1][lab6-sec1], [Section 2][lab6-sec2]): we used the **InvokeDeviceMethod** sample service in this lab. You can use this code in your own project, modifying the direct method name to correspond to your use case (e.g. **lights-on** or **door-unlock**).
