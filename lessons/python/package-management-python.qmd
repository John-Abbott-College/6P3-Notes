...
*Note: most of these notes were adapted directly from the Raspberry Pi docs: [Python on Raspberry Pi](https://www.raspberrypi.com/documentation/computers/os.html#python-on-raspberry-pi)*
