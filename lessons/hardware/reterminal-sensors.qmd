---
title: "reTerminal Setup & Sensors"
subtitle: Getting to know our reTerminals through their sensory capabilities.
order: 1
---
...
1. Install the Raspberry Pi OS image.
 - disassemble, flip the memory switch and use `usbboot/rpiboot` script to prepare internal memory.
 - use Raspberry Pi Image Flasher to flash new image.
...
There are some other helpful conveniences we can set up.

It is worth reading the entire Wiki article about the [reSeed Terminal](https://wiki.seeedstudio.com/reTerminal/)

5. Install python and the following system packages
	1. reTerminal
	2. gpiozero
...
During Lab 1, you updated, upgraded and installed some packages in the Raspberry Pi OS using the **apt command**
...
| `sudo apt upgrade`      | Apply updates from previous command |
